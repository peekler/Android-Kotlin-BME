package hu.aut.android.recipeproviderdemo
...
class MainActivity : AppCompatActivity() {
    ...
    private fun insertNewRecipe(recipe: String): Uri? {
        ...
        values.put(RecipeContract.RecipeEntry.COLUMN_DESC,
                "egg, milk, soda, liszt")

        return contentResolver.insert(
                RecipeContract.RecipeEntry.CONTENT_URI, values)
    }
